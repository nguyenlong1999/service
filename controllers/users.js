...
exports.createAdminAccount = (auth.optional, (req, res) => {
    const user = {
        email: req.body.user.email,
        password: req.body.user.password,
...
exports.resetPassword = (auth.optional, (req, res) => {
    const user = {
        email: req.body.user.email,
        password: req.body.user.password
    };
...
exports.login = (auth.optional, (req, res) => {
    const user = {
        name: req.body.user.user,
        email: req.body.user.email,
        password: req.body.user.password
...
//POST login route (optional, everyone has access)
exports.loginAdmin = (auth.optional, (req, res) => {
    const user = {
        name: req.body.user.user,
        email: req.body.user.email,
        password: req.body.user.password
